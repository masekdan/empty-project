...
void task_controller(void *t_args)
{
    ...
    int last_button_a_state = 1;
    int last_button_b_state = 1;
    int last_button_up_state = 1;
    int last_button_down_state = 1;
    int last_button_left_state = 1;
    int last_button_right_state = 1;
    ...
    while (1)
    {
        ...
        if (button_a_state == 0 && last_button_a_state == 1)
        {
            btnMsg = 1;
        }

        if (button_b_state == 0 && last_button_b_state == 1)
        {
            btnMsg = 2;
        }

        if (button_up_state == 0 && last_button_up_state == 1)
        {
            btnMsg = 3;
        }

        if (button_down_state == 0 && last_button_down_state == 1)
        {
            btnMsg = 4;
        }

        if (button_left_state == 0 && last_button_left_state == 1)
        {
            btnMsg = 5;
        }

        if (button_right_state == 0 && last_button_right_state == 1)
        {
            btnMsg = 6;
        }
